...
@objc public protocol ResizableViewDelegate: class {
    @objc optional func tapBegin(_ resizableView:ResizableView)
    @objc optional func tapChanged(_ resizableView:ResizableView)
    @objc optional func tapMoved(_ resizableView:ResizableView)
    @objc optional func tapEnd(_ resizableView:ResizableView)
}


@objc open class ResizableView: UIView, UIGestureRecognizerDelegate {
    
    @objc public weak var delegate: ResizableViewDelegate?
    ...
    @objc open var resizeEnabled = true {
        didSet {
    ...
    private var gripPointView = GripPointView()
    ...
    private func prepareGripPointView() {
        ...
        gripPointView = GripPointView(frame: bounds)
        gripPointView.isHidden = false
